<html lang="en">
  ...
  <body>
      ...
      <div class="container">
          ...
          <div class="col-12">
            ...
            >
              <div class="container-fluid position-relative">
                ...
                <div
                  class="collapse navbar-collapse position-absolute top-0 start-50 translate-middle"
                  id="navbar"
                >
        ...
        <div class="row intro_row">
          <div class="col-lg-6 col-12 mt-2 intro">
            ...
            <p>
              I'm a B.Tech student at NIT Delhi with a strong passion for
            ...
            <a href = "https://www.instagram.com/omagarwal1305/?next=%2F"><img height="50px" width="50px" src="icons8-instagram-144.png"> </a>
             <a href = "www.linkedin.com/in/0m-agarwal"><img height="50px" width="50px" src="icons8-linkedin-144.png"> </a>
              <a href = "https://github.com/om1305"><img height="40px" width="40px" src="7.png"> </a>
    ...
    <section id="project" class="project_color m-0 pt-2 pb-2">
    ...
    <section class="back container-fluid m-0">
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-12 m-4 mt-2 project">
            <img
          ...
          <div class="col-lg-6 col-12 m-5 project_text">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-6 mt-3">
            <img src="2.png" height="200px" width="200px" />
          </div>
          <div class="col-lg-3 col-6 mt-3">
            <img src="6.png" height="200px" width="200px" />
          </div>
          <div class="col-lg-3 col-6 mt-3">
            <img src="7.png" height="200px" width="200px" />
          </div>
          <div class="col-lg-3 col-6 mt-3">
            <img src="10.png" height="200px" width="200px" />
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6 mt-3">
            <img src="icons8-react-200.png" height="200px" width="200px" />
          </div>
          <div class="col-lg-3 col-6 mt-3">
            <img src="icons8-bootstrap-240.png" height="200px" width="200px" />
          </div>
          <div class="col-lg-3 col-6 mt-3">
            <img
    ...
    <section id="contact_me" class="project_color m-0 pt-4 pb-4">
